...
<h1>
<span class="action-span"><a href="{{URL('Admin/Attribute/attribute_list')}}">商品属性</a></span>
...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <tr>
        ...
        <td>
          <select name="goods_type" onchange="onChangeGoodsType(this.value)">
          <option value="0">请选择...</option>
            <option value="书">书</option><option value="音乐">音乐</option><option value="电影">电影</option><option value="手机">手机</option><option value="笔记本电脑">笔记本电脑</option><option value="数码相机">数码相机</option><option value="数码摄像机">数码摄像机</option><option value="化妆品">化妆品</option><option value="精品手机">精品手机</option><option value="10">我的商品</option>          </select> <span class="require-field">*</span>        </td>
      </tr>
      ...
      <tr>
        <td class="label"><a href="javascript:showNotice('noticeindex');" title="点击此处查看提示信息"><img src="{{URL::asset('images/notice.gif')}}" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>能否进行检索：</td>
        <td>
      ...
      <tr>
        <td class="label"><a href="javascript:showNotice('noticeAttrType');" title="点击此处查看提示信息"><img src="{{URL::asset('images/notice.gif')}}" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>属性是否可选</td>
        <td>
      ...
      <tr>
        ...
        <td>
          <input type="radio" name="attr_input_type" value="手动录入" checked="true" onclick="radioClicked(0)">
          手工录入          <input type="radio" name="attr_input_type" value="选择录入" onclick="radioClicked(1)">
          从下面的列表中选择（一行代表一个可选值）          <input type="radio" name="attr_input_type" value="多行文本" onclick="radioClicked(0)">
          多行文本框        </td>
      </tr>
      <tr>
