...
<h1>
    <span class="action-span"><a href="{{URL('Admin/Goods/goods_type_edit')}}">商品类型列表</a></span>
    <span class="action-span1"><a href="index.php?act=main">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 修改商品类型 </span>
    <div style="clear:both"></div>
</h1>

<div class="main-div">
    <form action="{{URL('/Admin/Goods/goods_type_edit_do')}}" method="post" name="theForm" onsubmit="return validate();">
