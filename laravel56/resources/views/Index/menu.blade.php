...
<head>
    ...
    <script type="text/javascript" src="{{URL::asset('js/transport.js')}}"></script>
    <style type="text/css">
        ...
        .explode {background: url({{URL::asset('images/menu_minus.gif')}}) no-repeat 0px 3px; font-weight: bold;}
        .collapse { background: url({{URL::asset('images/menu_plus.gif')}}) no-repeat 0px 3px; font-weight: bold;}
        .menu-item { background: url({{URL::asset('images/menu_arrow.gif')}}) no-repeat 0px 3px; font-weight: normal;}
...
<div id="tabbar-div">
    <p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img  src="{{URL::asset('images/menu_minus.gif')}}" id="toggleImg"  width="9" height="9" border="0" alt="闭合" ></a>
			</span>
        ...
        <ul id="menu-ul">
            <li class="explode" key="02_cat_and_goods" name="menu"> 商品管理
                <ul>
                    ...
                    <li class="menu-item"><a href="{{URL('Admin/Goods/goods_type_list')}}" target="main-frame">商品类型</a></li>
